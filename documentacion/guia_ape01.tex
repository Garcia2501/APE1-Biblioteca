...
\vspace{10pt}
\textbf{Anexo C: Elaboraci\'on del Informe en \LaTeX{}}

\vspace{4pt}
La redacci\'on y maquetaci\'on de este documento se realiz\'o \'integramente empleando el sistema de composici\'on de textos \LaTeX{}. Esto garantiz\'o un formato est\'andarizado, profesional y una \'optima presentaci\'on t\'ecnica para todos los bloques de c\'odigo fuente, f\'ormulas y elementos gr\'aficos.

Adicionalmente, todo el c\'odigo fuente del informe (archivos \texttt{.tex}, referencias \texttt{.bib} y la carpeta de im\'agenes) fue versionado e integrado al repositorio principal del proyecto en GitHub. Esta implementaci\'on adopta el paradigma de \textit{Docs as Code} (Documentaci\'on como C\'odigo), permitiendo que cualquier integrante del equipo pueda auditar el historial de la documentaci\'on con la misma trazabilidad con la que se gestiona el software.

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{images/subidaLatex.jpg}
\caption{Evidencia de la integraci\'on y subida del c\'odigo fuente de \LaTeX{} (archivos .tex y recursos multimedia) al repositorio p\'ublico de GitHub.}
\end{figure}
\end{adjustwidth}
